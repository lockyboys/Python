# [main_organizer.py] - 전체 시스템 통합 실행 파일 (v14 - Document Support)
import os
import sys
import config
import utils
...
import document_analyzer  # 문서 분석 모듈 추가
...
def run_total_organization(path_str):
    ...
    print(f"🌟 통합 폴더 정리 시스템(v14)을 시작합니다: {path_str}")
    ...
    # 2. 문서 지능형 분석 (PDF, HWP, Office, TXT)
    ...
    if gpu_active:
        print("🚀 NVIDIA GPU 가속 엔진이 모든 분석에 적용되었습니다.")
